...
-- Insertojme rolin LECTURER ne tabelen roles
INSERT INTO roles (role_name, created_at, created_by) VALUES ('LECTURER', NOW(), 'admin');

INSERT INTO person (name, email, mobile_number, pwd, role_id, created_at, created_by)
VALUES ('Emine', 'emine.21gura@gmail.com', '9876543210', '12345678', 
        (SELECT role_id FROM roles WHERE role_name = 'LECTURER'), 
        NOW(), 'admin');

INSERT INTO courses (name, fees, created_at, created_by)
VALUES ('New Programming Course', '1000', NOW(), 'admin');

INSERT INTO person_courses (person_id, course_id)
VALUES ((SELECT person_id FROM person WHERE email = 'emine.21gura@gmail.com'), 1);
